...
// FUNCIONS
int tooMuch(int puntos, bool repetir);
int ggwp(int puntos, bool repetir);
  ...
  do
  {
    ...
    if (turno == 0)
    {
      ...
      for (int contadorMano = 0; contadorMano < 52; contadorMano++)
      {
        ...
        {
          switch (mano[contadorMano].numero)
          {
          case 1:
      ...
      if (puntos > 21)
      {
        repetir = tooMuch(puntos, repetir);
        break;
      }
      else if (puntos == 21)
      {
        repetir = ggwp(puntos, repetir);
        break;
      }
      else
      {
    ...
    case 1:
      ...
      switch (mano[num_cartas_mano + 1].numero)
      {
      case 1:
        ...
        break;
      case 11:
        cout << "\033[1;33m Sota de " << mano[num_cartas_mano + 1].palo << "\033[0m" << endl;
        puntos = puntos + 10;
        num_cartas_mano++;
        break;
      case 12:
        cout << "\033[1;33m Caballo de " << mano[num_cartas_mano + 1].palo << "\033[0m" << endl;
        puntos = puntos + 10;
        num_cartas_mano++;
        break;
      case 13:
        cout << "\033[1;33m Rey de " << mano[num_cartas_mano + 1].palo << "\033[0m" << endl;
        puntos = puntos + 10;
        num_cartas_mano++;
        break;
      default:
        cout << "\033[1;33m " << mano[num_cartas_mano + 1].numero << " de " << mano[num_cartas_mano + 1].palo << "\033[0m" << endl;
